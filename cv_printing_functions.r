...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    if(sheet_is_publicly_readable){
      ...
      #googlesheets4::sheets_deauth() dtc: this is the original line, which is broken
      googlesheets4::gs4_deauth() # dtc: I added this following https://github.com/nstrayer/datadrivencv/issues/84
    } else {
  ...
  # Added following: https://github.com/nstrayer/datadrivencv/issues/30
  if(resume_mode){
